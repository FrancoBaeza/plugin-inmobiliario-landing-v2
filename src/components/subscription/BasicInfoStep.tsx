...
const BasicInfoStep: React.FC = () => {
  ...
  const { userInfo, updateUserInfo, nextStep } = useSubscription();
  ...
  const validateForm = (): boolean => {
    ...
    if (!userInfo.passwordConfirmation) {
      newErrors.passwordConfirmation = t('subscription.errors.confirmPasswordRequired');
      isValid = false;
    } else if (!validatePasswordMatch(userInfo.password, userInfo.passwordConfirmation)) {
      newErrors.passwordConfirmation = t('subscription.errors.passwordsDoNotMatch');
      isValid = false;
    }
